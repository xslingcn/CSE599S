# File from tensorrt_llm/runtime/enc_dec_model_runner.py
# Modified to support sampling params and return the log_probs
import json
import time
...
from tensorrt_llm._utils import torch_to_numpy, trt_dtype_to_torch, mpi_world_size, mpi_rank
from tensorrt_llm.plugin.plugin import CustomAllReduceHelper
from tensorrt_llm.runtime.generation import ModelConfig, SamplingConfig, LoraManager, GenerationSession
...
class EncDecModelRunner:
    ...
    def generate(self,
        ...
        if return_dict:
            log_probs = self.decoder_session.log_probs.cpu()
